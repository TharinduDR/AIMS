...
from aims.losses.loss_utils import init_loss
from aims.text_classification.text_classification_utils import (
    InputExample,
...
from aims.config import global_args
...
class TextClassificationModel:
    ...
    def load_and_cache_examples(
        ...
        if not multi_label and args.regression:
            ...
            output_mode = "text_classification"
        ...
        if args.sliding_window or self.args.model_type in ["layoutlm", "layoutlmv2"]:
            ...
            if output_mode == "text_classification":
    ...
    def compute_metrics(
        ...
        **kwargs,
        ...
        Returns:
            result: Dictionary containing evaluation results.
            For non-binary text_classification, the dictionary format is: (Matthews correlation coefficient, tp, tn, fp, fn).
            For binary text_classification, the dictionary format is: (Matthews correlation coefficient, tp, tn, fp, fn, AUROC, AUPRC).
